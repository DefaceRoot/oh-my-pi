...
export const SETTINGS_SCHEMA = {
	...
	topP: {
		...
		ui: {
			tab: "agent",
			label: "Top-P",
			description: "Nucleus sampling threshold (0-1, -1 = provider default)",
			submenu: true,
		},
	},
	topK: {
		...
		ui: {
			tab: "agent",
			label: "Top-K",
			description: "Top-K sampling cutoff (-1 = provider default)",
			submenu: true,
		},
	},
	minP: {
		...
		ui: {
			tab: "agent",
			label: "Min-P",
			description: "Minimum probability threshold for token filtering (-1 = provider default)",
			submenu: true,
		},
	},
	presencePenalty: {
		...
		ui: {
			...
			description: "Penalty for introducing already-mentioned topics (-1 = provider default)",
			submenu: true,
		},
	},
	repetitionPenalty: {
		...
		ui: {
			...
			description: "Penalty for repeated token patterns (-1 = provider default)",
			submenu: true,
		},
	},
	hideThinkingBlock: {
	...
	clearOnShrink: {
		...
		ui: {
			...
			description: "Clear empty rows when content shrinks to prevent stale viewport artifacts (may cause brief full redraw)",
		},
	},
	...
	"task.eager": {
		...
		ui: {
			tab: "tools",
			label: "Task eager mode",
			description: "Favor Task tool delegation for non-trivial work",
			submenu: true,
		},
	},
	"task.disabledAgents": {
...
export function getDefault<P extends SettingPath>(path: P): SettingValue<P> {
	...
	if (!def) return undefined as SettingValue<P>;
