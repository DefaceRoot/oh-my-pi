...
export class ModelRegistry {
	...
	// Newer OMP SDK expects these extension-provider hooks.
	// This patch bundle doesn't implement provider registration; keep them as no-ops
	// so upgrades don't break launch.
	syncExtensionSources(_activeSources: string[]): void {}
	clearSourceRegistrations(_sourceId: string): void {}
	registerProvider(_provider: string, _config: unknown, _sourceId: string): void {}
