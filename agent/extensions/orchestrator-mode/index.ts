...
function buildOrchestratorPrompt(): string {
	return [
		...
		"Bug reports, failing tests, and unexpected behavior MUST be delegated to the debug subagent.",
		"Use implement for known-good scoped changes after diagnosis is complete.",
