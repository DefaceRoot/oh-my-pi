...
export const STATUS_LINE_PRESETS: Record<StatusLinePreset, PresetDef> = {
	default: {
		leftSegments: ["pi", "model", "preset", "plan_mode", "path", "git", "pr", "context_pct", "token_total", "cost"],
		rightSegments: [],
	...
	compact: {
		leftSegments: ["model", "preset", "plan_mode", "git", "pr"],
	...
	full: {
		leftSegments: ["pi", "hostname", "model", "preset", "plan_mode", "path", "git", "pr", "subagents"],
	...
	nerd: {
		...
		leftSegments: ["pi", "hostname", "model", "preset", "plan_mode", "path", "git", "pr", "session", "subagents"],
		rightSegments: [
			"token_in",
			"token_out",
			"cache_read",
