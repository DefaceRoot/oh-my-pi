...
interface AppKeybindings {
	...
	"app.stt.toggle": true;
	"app.ask.toggle": true;
	"app.subagent.cycleForward": true;
	"app.subagent.cycleBackward": true;
...
export const KEYBINDINGS = {
	...
	"app.subagent.cycleForward": {
		defaultKeys: "ctrl+x",
		description: "Cycle to next subagent",
	},
	"app.subagent.cycleBackward": {
		defaultKeys: [],
		description: "Cycle to previous subagent",
	},
	"app.agent.cycleMode": {
		defaultKeys: "alt+a",
	...
	"app.worktree.toggle": {
		defaultKeys: "alt+w",
		description: "Toggle worktree menu",
	},
...
const KEYBINDING_NAME_MIGRATIONS = {
	...
	toggleAskMode: "app.ask.toggle",
	cycleSubagentForward: "app.subagent.cycleForward",
	cycleSubagentBackward: "app.subagent.cycleBackward",
	cycleAgentMode: "app.agent.cycleMode",
	lazygit: "app.lazygit",
	toggleWorktreeMenu: "app.worktree.toggle",
